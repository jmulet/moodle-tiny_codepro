 ...
 */
import {handleAction, requireCm6Pro} from "./ui";
import {getPref, setPref} from "./preferences";
import {isAutoFormatHTML} from "./options";
/**
 * @param {*} editor
 * @returns
 */
export function createView(editor) {
    ...
    return {
        buttons: [
            ...
            },
            {
                ...
                onAction: (api) => {
                    ...
                    codeEditorInstance.setWrap(!isWrap);
            ...
            },
            {
                ...
                tooltip: 'Toggle to Tinymce view',
                buttonType: 'primary',
                onAction: () => {
                    if (codeEditorInstance) {
                        const codeContent = codeEditorInstance.getValue();
        ...
        onShow: async(api) => {
            if (!codeEditorInstance) {
                ...
                cmElement.classList.add('tiny_widgethub-cm6-container');

                const shadowStyles = document.createElement('style');
                shadowStyles.textContent = `
                .tiny_widgethub-cm6-container {
                    height: 100%;
                }
                .cm-editor {
                    height: 100%;
                ...
                codeEditorInstance = new CodeProEditor(cmElement, changesListener);
            }
